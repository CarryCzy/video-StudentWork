        ...
        <div style="padding: 15px;">
            ...
            <div style="border: #beb9b0 solid 1px;margin-top: 20px;border-radius: 5px;">
                <div style="border-bottom: #beb9b0 solid 1px;height:40px;">
                    <h2 style="margin:10px 0 10px 15px;">地区列表</h2>
                </div>
...
<script>
    ...
    layui.use(['element','table','layer'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'operate',title:'操作'
                    ,templet:function (d) {
                        return '<div><a href="manager/area/detail/'+ d.id +'" class="operateBtn">查看</a><a class="operateBtn" lay-event="delete">删除</a></div>';
                    }
                }
            ]]
            ,page: {
        ...
        $(".searchBtn").click(function () {
            table.reload('test',{
                url:'manager/area/getByName'
                ,where:{id:$("input:eq(0)").val(),name:$("input:eq(1)").val()}
                ,method:'post'
            });
            return false;
        });
